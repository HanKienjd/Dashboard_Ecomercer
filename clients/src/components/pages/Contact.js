              ...
              <div className="content_header">
                <div className="header-main">
                  <div className="menu-bar-h nav-mobile-button hidden-lg">
                    <a href="https://thucphamsach.vgasoft.vn/"><img src="./VGA Delta Fruits - Liên Hệ_files/i_menubar.png" alt="menu" /></a>
                  </div>
                  <div className="col-lg-3 logo-main">
                    <div className="logo">
                      <a href="https://thucphamsach.vgasoft.vn/" className="logo-wrapper"><img src="./VGA Delta Fruits - Liên Hệ_files/13.png" alt="logo Delta Fruits" /></a>
                    </div>
                  </div>
                  <div className="
                        col-lg-7 col-md-7
                        ...
                        <div className="mini-cart text-xs-center">
                          <div className="heading-cart cart_header">
                            <a className="img_hover_cart" href="https://thucphamsach.vgasoft.vn/cart" title="Giỏ hàng"><div className="icon_hotline">
                                <img src="./VGA Delta Fruits - Liên Hệ_files/bag.png" alt="Giỏ hàng" /><span className="count_item_cart">0</span>
                              </div></a>
      ...
      <div className="breadcrumb_background">
        <div className="title_full">
          <div className="container a-center">
            <h1 className="title_page">Liên Hệ</h1>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="zalo-button-chat">
          <div className="zalo-chat-widget" data-oaid={76801581514589304} data-welcome-message="Rất vui khi được hỗ trợ bạn!" data-autopopup={0} data-width={350} data-height={420} style={{zIndex: 2147483647, border: 'none', visibility: 'visible', bottom: '0px', right: '0px', position: 'fixed', width: '70px', height: '70px', top: 'auto'}}>
            <iframe frameBorder={0} allowFullScreen scrolling="no" width={70} height={70} src="./VGA Delta Fruits - Liên Hệ_files/chat-widget.html" style={{position: 'absolute', bottom: '0px', right: '0px'}} />
      ...
      <nav className="quick-menu shadow-box bg-white" style={{zIndex: 9998}}>
        ...
        <div className="box__button_share" id="_no-clickjacking-0" style={{opacity: 1, overflow: 'visible'}}>
          ...
          <div className="fb-share-button fb_iframe_widget" data-href="https://thucphamsach.vgasoft.vn" data-layout="button" data-size="large" fb-xfbml-state="rendered" fb-iframe-plugin-query="app_id=&container_width=0&href=https%3A%2F%2Fthucphamsach.vgasoft.vn%2F&layout=button&locale=vi_VN&sdk=joey&size=large">
            <span style={{verticalAlign: 'bottom', width: '0px', height: '0px'}}><iframe name="f1d5af1a4f717b" width="1000px" height="1000px" data-testid="fb:share_button Facebook Social Plugin" title="fb:share_button Facebook Social Plugin" frameBorder={0} allowTransparency="true" allowFullScreen="true" scrolling="no" allow="encrypted-media" src="./VGA Delta Fruits - Liên Hệ_files/share_button.html" style={{border: 'none', visibility: 'visible', width: '0px', height: '0px'}} className /></span>
          </div>
          <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <div className="zalo-share-button" data-oaid={76801581514589304} data-layout={1} data-color="blue" data-href="https://thucphamsach.vgasoft.vn" data-customize="false" style={{overflow: 'hidden', display: 'inline-block', width: '70px', height: '20px'}}>
              <iframe frameBorder={0} allowFullScreen scrolling="no" width="70px" height="20px" src="./VGA Delta Fruits - Liên Hệ_files/share.html" />
            </div>
          </div>
        </div>
                  ...
                  <div className="media">
                    <div className="media-left">
                      <div className="thumb-1x1">
                        <img src="https://thucphamsach.vgasoft.vn/lien-he-59" />
                      </div>
                    </div>
                ...
                <div className="col-xs-12 col-sm-12 col-md-5 col-lg-3">
                  <div className="widget-ft last social_footer">
                    <div className="blocklogo">
                      <a href="https://thucphamsach.vgasoft.vn/" className="logofooter"><img src="./VGA Delta Fruits - Liên Hệ_files/13.png" alt="logo Delta Fruits" /></a>
                    </div>
                    <div className="contactfooter">
                      <div className="flop">
                        <span className="icon"><img src="./VGA Delta Fruits - Liên Hệ_files/headphone.png" alt="liên hệ ngay" /></span>
          ...
          <div className="payment_e">
            <div className="container a-center">
              <div className="iigpay">
                <img src="./VGA Delta Fruits - Liên Hệ_files/payment.png" alt="Các hình thức thành toán" />
              </div>
            </div>
          </div>
