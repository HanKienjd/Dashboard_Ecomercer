...
const Home = () => {
  return <React.Fragment> <div className="htop section">
...
<header className="header">
            ...
            <div className="row">
              <div className="content_header">
                <div className="header-main">
                  <div className="menu-bar-h nav-mobile-button hidden-lg"><a href="https://thucphamsach.vgasoft.vn/"><img src="./VGA Delta Fruits_files/i_menubar.png" alt="menu" /></a></div>
                  <div className="col-lg-3 logo-main">
                    <div className="logo"><a href="https://thucphamsach.vgasoft.vn/" className="logo-wrapper"><img src="./VGA Delta Fruits_files/13.png" alt="logo Delta Fruits" /></a></div>
                  </div>
                          ...
                          <div className="row row-noGutter-2">
                            <nav className="header-nav">
                              <ul className="item_big">
                                <li className="nav-item active"><a className="a-img" href="https://thucphamsach.vgasoft.vn/"><span>Trang
                                      chủ</span></a></li>
                                ...
                                <li className="nav-item"><a className="a-img" href="https://thucphamsach.vgasoft.vn/tin-tuc-68"><span>Tin
                                      Tức</span></a></li>
                      ...
                      <div className="top-cart-contain f-right">
                        <div className="mini-cart text-xs-center">
                          <div className="heading-cart cart_header"><a className="img_hover_cart" href="https://thucphamsach.vgasoft.vn/cart" title="Giỏ hàng">
                              <div className="icon_hotline"><img src="./VGA Delta Fruits_files/bag.png" alt="Giỏ hàng" /><span className="count_item_cart">0</span></div>
                            </a>
      ...
      <div className="owl-carousel home-slider owl-carousel owl-theme owl-loaded owl-drag" id="id-401-888">
        <div className="owl-stage-outer">
          <div className="owl-stage" style={{transform: 'translate3d(0px, 0px, 0px)', transition: 'all 0s ease 0s', width: '1520px'}}>
            <div className="owl-item active" style={{width: '1519.2px'}}>
              <div className="item"><a className="clearfix" style={{width: '100%', display: 'block'}}><img src="./VGA Delta Fruits_files/slider_1.png" alt="VGA Delta Fruits" style={{width: '100%'}} /></a></div>
            </div>
          </div>
        </div>
        <div className="owl-nav disabled"><button type="button" role="presentation" className="owl-prev"><span classname="next-ex" /></button><button type="button" role="presentation" className="owl-next"><span classname="next-ex" /></button></div>
      ...
      <div className="facebook-button-chat">
          <div className="fb-customerchat" attribution="setup_tool" theme_color="#0084ff" page_id={103011295020063} logged_in_greeting="Bạn cần tư vấn gì?" logged_out_greeting="Bạn cần tư vấn gì?">
          </div>
        </div>
        <div className="zalo-button-chat">
          <div className="zalo-chat-widget" data-oaid={76801581514589304} data-welcome-message="Rất vui khi được hỗ trợ bạn!" data-autopopup={0} data-width={350} data-height={420} style={{zIndex: 2147483647, border: 'none', visibility: 'visible', bottom: '0px', right: '0px', position: 'fixed', width: '70px', height: '70px', top: 'auto'}}>
            <iframe frameBorder={0} allowFullScreen scrolling="no" width={70} height={70} src="./VGA Delta Fruits_files/chat-widget.html" style={{position: 'absolute', bottom: '0px', right: '0px'}} />
        ...
        <div className="box__button_share" id="_no-clickjacking-0" style={{opacity: 1, overflow: 'visible'}}>
          ...
          <div className="fb-share-button" data-href="https://thucphamsach.vgasoft.vn" data-layout="button" data-size="large"><a target="_blank" rel="noreferrer" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&src=sdkpreparse" className="fb-xfbml-parse-ignore" /></div>
          <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <div className="zalo-share-button" data-oaid={76801581514589304} data-layout={1} data-color="blue" data-href="https://thucphamsach.vgasoft.vn" data-customize="false" style={{overflow: 'hidden', display: 'inline-block', width: '70px', height: '20px'}}>
              <iframe frameBorder={0} allowFullScreen scrolling="no" width="70px" height="20px" src="./VGA Delta Fruits_files/share.html" />
            </div>
          </div>
        </div>
                ...
                <div className="modal-body">
                  <div className="media">
                    <div className="media-left">
                      <div className="thumb-1x1"><img src="https://thucphamsach.vgasoft.vn/" /></div>
                    </div>
        ...
        <div className="site-footer">
              ...
              <div className="row">
                <div className="col-xs-12 col-sm-12 col-md-5 col-lg-3">
                  <div className="widget-ft last social_footer">
                    <div className="blocklogo"><a href="https://thucphamsach.vgasoft.vn/" className="logofooter"><img src="./VGA Delta Fruits_files/13.png" alt="logo Delta Fruits" /></a></div>
                    <div className="contactfooter">
                      <div className="flop"><span className="icon"><img src="./VGA Delta Fruits_files/headphone.png" alt="liên hệ ngay" /></span>
                      ...
                      <div className="flop mt">
                        ...
                        <div className="section flex"><span className="icon"><img src="./VGA Delta Fruits_files/place.png" alt="Số 20, Ngõ 118, ngách 8, hẻm 1 Nguyễn Khánh Toàn" /></span>
                          <div className="fright"><span>Số 20, Ngõ 118, ngách 8, hẻm 1 Nguyễn
                              Khánh Toàn</span></div>
                        </div>
                        <div className="section flex"><span className="icon"><img src="./VGA Delta Fruits_files/email.png" alt="contact@vgasoft.vn" /></span>
          ...
          <div className="payment_e">
            <div className="container a-center">
              <div className="iigpay"><img src="./VGA Delta Fruits_files/payment.png" alt="Các hình thức thành toán" /></div>
            </div>
          </div>
